   ...
   return (
      <div className="max-w-[1200px] mx-auto animate-in fade-in duration-500 space-y-10 pb-20">
         ...
         <div className="bg-soft-blue p-16 rounded-[4rem] text-slate-900 relative overflow-hidden shadow-2xl border border-blue-100 group">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-400/10 rounded-full blur-[100px] translate-y-1/3 -translate-x-1/4" />
            <div className="relative z-10 space-y-6">
               <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-md border border-blue-200 px-4 py-2 rounded-2xl">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-[10px] font-black uppercase tracking-widest text-blue-700">Wellness Verified</span>
               </div>
               ...
               <p className="text-slate-700 font-bold max-w-xl text-lg selection:bg-primary/20 leading-relaxed">Your personalized health sanctuary is active. Track recovery metrics, manage prescriptions, and consult your health specialists seamlessly.</p>
               <div className="flex flex-wrap gap-6 pt-6">
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-[2.5rem] border border-white min-w-[140px] hover:bg-white transition-all shadow-xl group/card">
                     <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2 group-hover/card:text-primary">Health Index</p>
                     <p className="text-4xl font-black text-slate-900 tracking-tighter">87%</p>
                  </div>
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-[2.5rem] border border-white min-w-[140px] hover:bg-white transition-all shadow-xl group/card">
                     <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2 group-hover/card:text-primary">Next Event</p>
                     <p className="text-4xl font-black text-slate-900 tracking-tighter">Feb 22</p>
                  </div>
                  <div className="bg-white/80 backdrop-blur-md p-6 rounded-[2.5rem] border border-white min-w-[140px] hover:bg-white transition-all shadow-xl group/card">
                     <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2 group-hover/card:text-primary">Active Rx</p>
